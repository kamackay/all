...
type Opts struct {
	...
	Sort      string `short:"S" enum:"size,time,modified,created,name,none" help:"Sorting options. One of size, time (alias of modified), modified, created, name, none" default:"name"`
